...
This update fixes a number of minor issues:
  ...
  - Fixed an issue in HEATR when calculating the average outgoing energy from a distributiaon that uses multiple interpolation ranges in TAB1 records (test 79 was added to detect this issue in the future).
